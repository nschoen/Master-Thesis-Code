"""
Explain final EdgeGlobal model trained on EH PRO dataset with Grad-CAM.

Samples from folder <root>/src/explanation_methods/samples/eh_mmm are used.
"""
