...
if __name__ == '__main__':
    ...
    mat_path = join(dirname(__file__), 'results/point_dropping/mat-gradcam-noHU-113pcds-3000drops-100steps.npz')
    exp.load_by_npz_name(mat_path)
    exp.num_drops = num_drops
    auc = exp.get_area_under_the_curve()

    print('PointNet++ Point Grad-CAM no-heatmap-updates 3000 drops')
    print("AUC", auc)
