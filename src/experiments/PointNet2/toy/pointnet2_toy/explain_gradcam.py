"""
Executes Grad-CAM on the final PointNet model trained on Toy dataset.

It uses a few demo samples of the folder <root>/src/explanation_methods/samples/toy
"""
...
model.explain_samples("toy", xai_method='gradcam', discrete_heatmap=False)