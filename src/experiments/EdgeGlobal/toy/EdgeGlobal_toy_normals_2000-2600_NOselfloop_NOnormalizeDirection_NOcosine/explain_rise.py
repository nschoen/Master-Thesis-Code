...
It uses a few demo samples of the folder <root>/src/explanation_methods/samples/toy-2400w
"""
...
config = {
    ...
    "epochs": 252,
    "workers": 4,
    "batch_size": 64,  # reduce this if you get a out of memory error
    "learning_rate": 0.001,
...
model.train()
model.explain_samples("toy-2400", xai_method='rise', discrete_heatmap=True)
