"""
Executes Grad-CAM on the final PointNet model trained on EH MMM dataset.

It uses a few demo samples of the folder <root>/src/explanation_methods/samples/eh_mmm
"""
...
config = {
    "model": "PointNet",
    "result_path": './pointnet_mmm_normals',
    "device": "cuda:0",
    "epochs": 400,
    "workers": 4,
    "batch_size": 64,
...
model.train()
model.explain_samples('eh_mmm', xai_method='gradcam')