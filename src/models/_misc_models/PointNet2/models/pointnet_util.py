...
class PointNetSetAbstraction(nn.Module):
    ...
    def forward(self, xyz, points):
        ...
        # CHANGED track xyz [1, 128, 3] and new_points [1, 1024, 128, 1] and hook for the gradient
        if hasattr(self, 'save_pre_max_features'):
            self.save_pre_max_features(xyz, new_points)
        # END
