...
class CustomEdgeConv(MessagePassing):
    ...
    def forward(self, pos, edge_index: Adj) -> Tensor:
        """"""
        ...
        return self.propagate(edge_index, x=pos, size=None)
...
class ASAP(torch.nn.Module):
    def __init__(self, num_classes, num_input_channels, num_layers=10, hidden=64, ratio=0.7, dropout=0.1):
        ...
        self.conv1 = CustomEdgeConv(nn=MLP([2 * 3, hidden, hidden, hidden]), aggr="max")
