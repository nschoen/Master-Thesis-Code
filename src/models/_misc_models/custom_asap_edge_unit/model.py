...
class ASAP(torch.nn.Module):
    def __init__(self, num_classes, num_input_channels, num_layers=10, hidden=64, ratio=0.9, dropout=0.1):
        ...
        self.conv2 = GraphConv(16, hidden, aggr='mean')
...
class Model(BaseModel):
    def get_model(self, num_classes=9):
        ...
        self.model = ASAP(num_classes=num_classes, num_layers=num_layers, ratio=ratio, num_input_channels=num_input_channels)
