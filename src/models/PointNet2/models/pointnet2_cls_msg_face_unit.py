...
class get_model(nn.Module):
    def __init__(self, num_class, normal_channel=True, first_SA_n_sample_factor=1):
        ...
        in_channel = 15  # 3 if normal_channel else 0
        self.normal_channel = True
        self.sa1 = PointNetSetAbstractionMsg(512, [0.1, 0.2, 0.4], [16*first_SA_n_sample_factor, 32*first_SA_n_sample_factor, 128*first_SA_n_sample_factor], in_channel, [[32, 32, 64], [64, 64, 128], [64, 96, 128]])
